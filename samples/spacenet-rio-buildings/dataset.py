...
class SpaceNetChallengeConfig(Config):
    ...
    # Random crops (no rescaling) of size 320x320 (CrowdAI)
    # "Image cutouts for the pan-sharpened 3-band imagery are
    # 438–439 pixels in width, and 406–407 pixels in height."
    ...
    # Image mean (RGB)
    MEAN_PIXEL = np.array([81.0541178, 86.41590797, 64.59318455])

    # 5th place (nucleus): https://www.kaggle.com/c/data-science-bowl-2018/discussion/56326
    ...
    # Configuration: https://github.com/mirzaevinom/data_science_bowl_2018/blob/master/codes/config.py
    ...
    # For the hyper-parameters, we therefore set [128, 128] ... as MINI_MASK_SHAPE."
